/**
 * Bidirectional mapping between XClaw statuses/priorities and GitHub labels.
...
const STATUS_LABEL_MAP: Record<TaskStatus, LabelDef> = {
  inbox:          { name: 'mc:inbox',          color: '6b7280', description: 'XClaw: inbox' },
  assigned:       { name: 'mc:assigned',       color: '3b82f6', description: 'XClaw: assigned' },
  in_progress:    { name: 'mc:in-progress',    color: 'eab308', description: 'XClaw: in progress' },
  review:         { name: 'mc:review',         color: 'a855f7', description: 'XClaw: review' },
  quality_review: { name: 'mc:quality-review', color: '6366f1', description: 'XClaw: quality review' },
  done:           { name: 'mc:done',           color: '22c55e', description: 'XClaw: done' },
}
