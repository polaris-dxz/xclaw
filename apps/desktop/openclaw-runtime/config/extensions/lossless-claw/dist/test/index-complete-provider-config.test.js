...
function buildApi(loadConfigResult) {
    let factory;
...
describe("createLcmDependencies.complete provider config resolution", () => {
    ...
    it("falls back to api.runtime.config.loadConfig() and resolves provider config fields", async () => {
        ...
        expect(piAiMock.completeSimple).toHaveBeenCalledWith(expect.objectContaining({
            id: "unit-model",
            provider: "unit-proxy",
            api: "openai-completions",
            baseUrl: "https://proxy.example.test/v1",
...
//# sourceMappingURL=index-complete-provider-config.test.js.map