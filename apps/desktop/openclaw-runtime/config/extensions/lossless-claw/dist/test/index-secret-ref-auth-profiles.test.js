...
describe("auth-profile SecretRef resolution in complete()", () => {
    ...
    it("resolves env-backed tokenRef values from auth-profiles.json", async () => {
        ...
        expect(piAiMock.completeSimple).toHaveBeenCalledWith(expect.any(Object), expect.any(Object), expect.objectContaining({
...
//# sourceMappingURL=index-secret-ref-auth-profiles.test.js.map