...
import { extensionFromNameOrMime, extractFileIdsFromContent, formatFileReference, generateExplorationSummary, parseFileBlocks, } from "../src/large-files.js";
...
describe("large-files helpers", () => {
    it("formats compact file references", () => {
        ...
        expect(text).toContain("[LCM File: file_aaaaaaaaaaaaaaaa | paper.pdf | application/pdf | 42,150 bytes]");
    ...
    it("extracts file ids in order without duplicates", () => {
        const ids = extractFileIdsFromContent("See file_aaaaaaaaaaaaaaaa and file_bbbbbbbbbbbbbbbb then file_aaaaaaaaaaaaaaaa again.");
...
//# sourceMappingURL=large-files.test.js.map