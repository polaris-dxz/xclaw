...
import { getExpansionDelegationTelemetrySnapshotForTests, resetExpansionDelegationGuardForTests, stampDelegatedExpansionContext, } from "../src/tools/lcm-expansion-recursion-guard.js";
...
describe("runDelegatedExpansionLoop recursion guard", () => {
    ...
    it("blocks delegated expansion helper re-entry at depth cap", async () => {
        ...
        expect(result.error).toContain("Recovery: In delegated sub-agent sessions, call `lcm_expand` directly");
...
//# sourceMappingURL=lcm-expand-tool.delegation.test.js.map