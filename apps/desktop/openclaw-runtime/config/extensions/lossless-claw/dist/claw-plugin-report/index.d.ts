 ...
 * ```
 */
export declare class GalileoReport {
    /** 单例实例 */
     ...
     * @param options - 事件参数
     */
    reportFuncAsync(name: string, options?: Record<string, any>): Promise<void>;
    /**
     * 设置上报公共参数
     *
     ...
     */
    readSharedParams(): import("./reporter.js").QClawSharedParams;
    /**
     * 从共享参数同步到 SDK 内部缓存
     */
