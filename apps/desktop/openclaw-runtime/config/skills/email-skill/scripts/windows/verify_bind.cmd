@echo off
REM verify_bind.cmd — 校验验证码并绑定邮箱 (Windows CMD版)
REM
REM 用法:
REM   verify_bind.cmd --email EMAIL --code CODE
...
if "%CODE%"=="" (
    echo {"success": false, "error_code": 1, "message": "缺少必填参数: code"}
    exit /b 1
)
